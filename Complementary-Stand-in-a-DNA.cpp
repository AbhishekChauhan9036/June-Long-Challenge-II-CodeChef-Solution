...
void BhagwatGeeta(){
	...
	cin>>__suttamar;
	string ___gangaw="";
	for(int lllll=0;lllll<__suttamar.length();lllll++){
		if(__suttamar[lllll]=='A'){
			___gangaw.push_back('T');
		}else if(__suttamar[lllll]=='T'){
			___gangaw.push_back('A');
		}else if(__suttamar[lllll]=='C'){
			___gangaw.push_back('G');
		}else{
			___gangaw.push_back('C');
		}
	}
	cout<<___gangaw<<endl;
